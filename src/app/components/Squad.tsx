...
export const Squad = () => {
  ...
  return (
    <section id="squad" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tighter leading-tight">
              LES GUERRIERS DE{" "}
          ...
          <div className="flex gap-4">
            <button onClick={() => setFilter("Gardien")} className="px-6 py-3 bg-white border-2 border-gray-200 rounded-xl font-bold hover:border-red-600">
              Gardiens
            </button>
            <button onClick={() => setFilter("Milieu")} className="px-6 py-3 bg-white border-2 border-gray-200 rounded-xl font-bold hover:border-red-600">
              Milieux
            </button>
            <button onClick={() => setFilter("Attaquant")} className="px-6 py-3 bg-white border-2 border-gray-200 rounded-xl font-bold hover:border-red-600">
              Attaquants
            </button>
            <button onClick={() => setFilter("Défenseur")} className="px-6 py-3 bg-white border-2 border-gray-200 rounded-xl font-bold hover:border-red-600">
              Défenseurs
            </button>
            <button onClick={() => setFilter("Tous")} className="px-6 py-3 bg-red-600 text-white rounded-xl font-bold">
              Tous
            </button>
          </div>
        </div>
          ...
          {filteredPlayers.map((player, index) => (
            ...
            >
              <div className="relative h-70 overflow-hidden">
                <ImageWithFallback src={player.img} alt={player.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
